...
--  rgbs = [(0, 24, 92), (63, 29, 64), (84, 19, 41), (12, 100, 130), (94, 0, 0)]
--  def convert(num):
--      if num < 0: tmp = 0
...
set myColor4 to {24158.0, 0.0, 0.0}
set myColor4dark to {18504.0, 0.0, 0.0}
set myColor4bright to {29812.0, 5654.0, 5654.0}
